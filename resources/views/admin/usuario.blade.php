...
<div class="flex-1 p-2 md:ml-64">
        <!-- Usuarios -->
        <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row justify-between mb-6">
            <h1 class="text-4xl font-bold">Usuarios Registrados</h1>
            <form action="/admin/buscadorUsuario" method="post" class="flex w-full max-w-md">
                @csrf
