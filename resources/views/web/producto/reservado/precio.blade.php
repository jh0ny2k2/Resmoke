...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white px-6 py-6 rounded-lg shadow-lg w-full ">
        <h1 class="text-4xl font-bold">Marcar como Reservado - Precio</h1>
        <h2 class="pt-2 pb-8">Asigna el precio de la reserva</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="flex-shrink-0">
                ...
                <form action="/web/precioReservado/{{ $producto->id }}/{{ $usuario->id }}" method="post" class="mt-1 p-2 bg-gray-50 border border-gray-300 rounded-md shadow-sm">
                @csrf
