...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white px-6 py-6 rounded-lg shadow-lg w-full ">
        <h1 class="text-4xl font-bold">Marcar como vendido - Usuario</h1>
        <h2 class="pt-2 pb-8">Busca al usuario comprador</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">

            <!-- Buscador de usuario -->
            <div class="flex-1">
                <form action="/web/buscadorUsuarioVender/{{ $producto->id }}" method="post">
                @csrf
                ...
                <div id="resultadoBusqueda" class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    @if(isset($usuarios))
                        ...
                        <a href="/web/precioVender/{{ $producto->id }}/{{ $usuario->id }}" class="block p-4 border text-gray-900 border-gray-300 rounded-lg shadow-md hover:bg-gray-200 transition duration-300 mt-2">
